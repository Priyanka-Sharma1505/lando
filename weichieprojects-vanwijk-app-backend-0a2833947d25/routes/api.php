...
Route::group(['middleware' => ['api', 'jwt.auth']], function($router) {
    ...
    Route::post('/scan/deregister/complete', [\App\Http\Controllers\postScanDeregisterCompleteController::class, 'index']);

    Route::post('/scan/return', [\App\Http\Controllers\postScanReturnController::class, 'index']);
    Route::post('/scan/return/complete', [\App\Http\Controllers\postScanReturnCompleteController::class, 'index']);
